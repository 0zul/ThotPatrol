...
cd "$(dirname "$0")" || cd . || (echo "This script should be run where ThotPatrol is located." && exit 1)
...
echo
print::message "Get Help/Support in ThotPatrol HQ: https://discord.gg/fzx8fkt"
print::message "Join ThotPatrol HQ and stay updated on important announcements, new releases, giveaways, etc."
echo
