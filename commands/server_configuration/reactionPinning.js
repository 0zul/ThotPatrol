...
exports.exec = async (ThotPatrol, message) => {
  ...
  await message.channel.send({
    embed: {
      color: ThotPatrol.colors[guildModel.dataValues.reactionPinning ? 'RED' : 'GREEN'],
      description: ThotPatrol.i18n.info(message.guild.language, guildModel.dataValues.reactionPinning ? 'disableReactionPinning' : 'enableReactionPinning', message.author.tag)
    }
  }).catch(e => {
