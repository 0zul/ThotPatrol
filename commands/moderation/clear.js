...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  if (!clearedMessages.size) {
    return ThotPatrol.emit('error', '', ThotPatrol.i18n.error(message.guild.language, 'noDeletableMessage'), message.channel);
  }
  ...
  ThotPatrol.emit('moderationLog', message, this.help.name, message.channel, reason, {
