...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  if (user.lastMessageID) {
    ...
    description = ThotPatrol.i18n.info(message.guild.language, 'lastSeen', user.tag, lastSeen);
  }
  else {
    color = ThotPatrol.colors.RED;
    description = ThotPatrol.i18n.info(message.guild.language, 'notSeen', user.tag);
  }
...
exports.help = {
  ...
  example: [ 'lastSeen @ThotPatrol#0001', 'lastSeen 167144269485733961' ]
};
