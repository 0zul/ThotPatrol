...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  if (args.amount) {
    ...
    mentionSpamStats = ThotPatrol.i18n.info(message.guild.language, 'enableMentionSpamFilter', message.author.tag, args.amount, args.action);
  }
  else {
    await ThotPatrol.database.models.guild.update({
    ...
    mentionSpamStats = ThotPatrol.i18n.info(message.guild.language, 'disableMentionSpamFilter', message.author.tag);
  }
