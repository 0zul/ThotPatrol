...
exports.exec = async (ThotPatrol, message, args) => {
  let guilds = Array.from(ThotPatrol.guilds.values());
  ...
  await message.channel.send({
    embed: {
      ...
      title: 'Server List',
      description: `ThotPatrol is connected to **${totalGuilds}** servers${ThotPatrol.shard ? `, in Shard ${ThotPatrol.shard.id}` : ''}.`,
      fields: fields,
      footer: {
...
exports.help = {
  name: 'listServers',
  description: 'Lists all Discord servers that ThotPatrol is connected to, in the current shard.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
