...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  let anime = await ThotPatrol.methods.makeBWAPIRequest('/kitsu/anime', {
    qs: {
      name: args.name
    }
  });
  ...
  if (anime) {
    ...
    return ThotPatrol.emit('error', '', ThotPatrol.i18n.error(message.guild.language, 'notFound', 'anime'), message.channel);
  }
};
