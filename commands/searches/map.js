...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  let options = {
    url: `https://maps.googleapis.com/maps/api/staticmap?center=${encodeURIComponent(args[0])}&zoom=${args[1]}&size=600x300&maptype=roadmap%20&markers=color:blue|${encodeURIComponent(args[0])}&key=${ThotPatrol.credentials.googleAPIkey}`,
    encoding: null
  };
