...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  let description = message.author.id === args.id ? `**${args.tag}** you have collected **${xp}** experience points out of ${ThotPatrol.methods.getRequiredExpForLevel(parseInt(level, 10) + 1)} that you can acquire in this level.` : `**${args.tag}** has collected **${xp}** experience points.`;
