...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  let footer = message.author.id === args.id && guildMemberModel.dataValues.experiencePoints !== '44444444444444' ? `Wanna go to the next level? Just gain ${ThotPatrol.methods.getRequiredExpForLevel(parseInt(level, 10) + 1) - xp + 1} more XP.` : null;
