...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  if (!recentUsers.includes(message.author.id)) {
    ...
    if (user.id === message.author.id) {
      return ThotPatrol.emit('error', '', 'You can\'t give karma to yourself!', message.channel);
    }
    ...
    return ThotPatrol.emit('error', '', `You have recently given karma to someone, please wait at least ${COOLDOWN} hours before giving karma again.`, message.channel);
  }
};
