...
exports.exec = async (ThotPatrol, message, args) => {
  ...
  if (args.song) {
     ...
     */
    let [ playlistModel, initialized ] = await ThotPatrol.database.models.playlist.findOrBuild({
      where: {
    ...
    await message.channel.send({
      embed: {
        color: ThotPatrol.colors[args.remove ? 'RED' : 'GREEN'],
    ...
    await message.channel.send({
      embed: {
        ...
        title: 'ThotPatrol Music Playlist',
