 ...
 * @function ThotPatrol.log.info
 * @param {...string} message Message(s) to be shown in the log as information/notes.
 * @returns {void}
 */
exports.info = (...message) => {
  console.log(COLOR.cyan('[ThotPatrol]: ') + COLOR.yellow(...message));
};

/**
 * Used to display a single messages in the log.
 * @function ThotPatrol.log.message
 * @param {string} message Message to be shown in the log.
 * @returns {void}
 */
exports.message = message => {
  console.log(COLOR.cyan('[ThotPatrol]: ') + message);
};

/**
 * Used to display the error messages.
 * @function ThotPatrol.log.console
